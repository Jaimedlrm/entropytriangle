...
class TernaryAxesSubplot(object):
    ...
    def left_axis_label(self, label, position=None,  rotation=-60, offset=0.08,
        ...
        if not position:
            position = (-0.44 - 0.7*offset, 0.482 - 0.25*offset, 0)
    ...
    def right_axis_label(self, label, position=None, rotation=60, offset=0.08,
        ...
        if not position:
            position =  (-0.44 - 0.7*offset, 1.045 - 0.25*offset, 0.5)
        self._labels["right"] = (label, position, rotation, kwargs)

    def bottom_axis_label(self, label, position=None, rotation=0, offset=0.08,
                          **kwargs):
        """
        ...
        if not position:
            position = (-1 - 0.15* offset, 0.84 + 2.15 * offset, 0)
            #position = (-1 - 0.15* offset, 0.86 + 2.15 * offset, 0)
